...
const DoctorLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("doctorAddress", response.data.decryptedAddress);
  ...
  return (
    <div className="login-container">
      ...
      <p className="login-description">Welcome back, doctor! Please login to access your account.</p>
